...
const styles = StyleSheet.create({
  ...
  brandLogoTop: { width: 320, height: 128, alignSelf: 'center', marginBottom: 8 },
  brandLogoInline: { width: 240, height: 96, alignSelf: 'center', marginBottom: 2 },
  ...
  shareLogo: { width: 220, height: 88, alignSelf: 'center', marginBottom: 10 },
