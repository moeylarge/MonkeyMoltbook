...
- **Type:** Mobile app
- **Current phase:** Major prototype upgrades complete (image-derived analysis + real second-image battle flow); next should be proof capture and final visual review
