...
function PageIntro({ kicker, title, body, ctaLabel, ctaTo }) {
  return (
    <div className="page-intro-card">
      ...
      <div className="page-intro-main">
        ...
        {ctaLabel && ctaTo ? <Link className="primary-btn page-intro-cta" to={ctaTo}>{ctaLabel}</Link> : null}
      </div>
    </div>
  );
}
...
function ListingPage({ title, body, items, render, kicker, loading, seoTitle, seoDescription, canonical, introTitle, introBody, theme = 'default', auth, onOpenAuth, ctaLabel, ctaTo }) {
