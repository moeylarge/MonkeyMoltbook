# MonkeyMoltbook — BACKLOG

Updated: 2026-03-29 America/Los_Angeles

Use this file for deferred work only.
Do not duplicate the active task list from `NOW.md`.

## Deferred / not now

- decide whether any second-stage candidate logic should be promoted into final suspicious family outputs
